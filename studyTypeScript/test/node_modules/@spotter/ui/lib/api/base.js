...
// @ts-ignore
var BASE_PATH = exports.BASE_PATH = 'http://localhost'.replace(/\/+$/, '');

/**
 *
 * @export
 */
var COLLECTION_FORMATS = exports.COLLECTION_FORMATS = {
  csv: ',',
  ssv: ' ',
  tsv: '\t',
  pipes: '|'
 ...
 * @class BaseAPI
 */
var BaseAPI = exports.BaseAPI = /*#__PURE__*/_createClass(function BaseAPI(configuration) {
 ...
 * @extends {Error}
 */
var RequiredError = exports.RequiredError = /*#__PURE__*/function (_Error) {
 ...
 * @export
 */
var operationServerMap = exports.operationServerMap = {};
