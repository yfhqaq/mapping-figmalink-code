...
var require_babel = __commonJS({
  "node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      ...
      var Xs = Object.getPrototypeOf, Gs = Object.prototype.hasOwnProperty;
      var Lt = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), Ys = (a, t) => {
        for (var e in t)
          we(a, e, { get: t[e], enumerable: true });
      }, Dt = (a, t, e, s) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let i of Js(t))
            !Gs.call(a, i) && i !== e && we(a, i, { get: () => t[i], enumerable: !(s = Ws(t, i)) || s.enumerable });
        return a;
      };
      var qe = (a, t, e) => (e = a != null ? Hs(Xs(a)) : {}, Dt(t || !a || !a.__esModule ? we(e, "default", { value: a, enumerable: true }) : e, a)), Qs = (a) => Dt(we({}, "__esModule", { value: true }), a);
      var wt = Lt((Pe) => {
        "use strict";
...
- Did you mean \`import { "${a}" as foo }\`?`, ImportCallArgumentTrailingComma: "Trailing comma is disallowed inside import(...) arguments.", ImportCallArity: ({ maxArgumentCount: a }) => `\`import()\` requires exactly ${a === 1 ? "one argument" : "one or two arguments"}.`, ImportCallNotNewExpression: "Cannot use new with import(...).", ImportCallSpreadArgument: "`...` is not allowed in `import()`.", ImportJSONBindingNotDefault: "A JSON module can only be imported with `default`.", ImportReflectionHasAssertion: "`import module x` cannot have assertions.", ImportReflectionNotBinding: 'Only `import module x from "./module"` is valid.', IncompatibleRegExpUVFlags: "The 'u' and 'v' regular expression flags cannot be enabled at the same time.", InvalidBigIntLiteral: "Invalid BigIntLiteral.", InvalidCodePoint: "Code point out of bounds.", InvalidCoverInitializedName: "Invalid shorthand property initializer.", InvalidDecimal: "Invalid decimal.", InvalidDigit: ({ radix: a }) => `Expected number in radix ${a}.`, InvalidEscapeSequence: "Bad character escape sequence.", InvalidEscapeSequenceTemplate: "Invalid escape sequence in template.", InvalidEscapedReservedWord: ({ reservedWord: a }) => `Escape sequence in keyword ${a}.`, InvalidIdentifier: ({ identifierName: a }) => `Invalid identifier ${a}.`, InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Ie(a)}.`, InvalidLhsBinding: ({ ancestor: a }) => `Binding invalid left-hand side in ${Ie(a)}.`, InvalidLhsOptionalChaining: ({ ancestor: a }) => `Invalid optional chaining in the left-hand side of ${Ie(a)}.`, InvalidNumber: "Invalid number.", InvalidOrMissingExponent: "Floating-point numbers require a valid exponent after the 'e'.", InvalidOrUnexpectedToken: ({ unexpected: a }) => `Unexpected character '${a}'.`, InvalidParenthesizedAssignment: "Invalid parenthesized assignment pattern.", InvalidPrivateFieldResolution: ({ identifierName: a }) => `Private name #${a} is not defined.`, InvalidPropertyBindingPattern: "Binding member expression.", InvalidRecordProperty: "Only properties and spread elements are allowed in record definitions.", InvalidRestAssignmentPattern: "Invalid rest operator's argument.", LabelRedeclaration: ({ labelName: a }) => `Label '${a}' is already declared.`, LetInLexicalBinding: "'let' is disallowed as a lexically bound name.", LineTerminatorBeforeArrow: "No line break is allowed before '=>'.", MalformedRegExpFlags: "Invalid regular expression flag.", MissingClassName: "A class name is required.", MissingEqInAssignment: "Only '=' operator can be used for specifying default value.", MissingSemicolon: "Missing semicolon.", MissingPlugin: ({ missingPlugin: a }) => `This experimental syntax requires enabling the parser plugin: ${a.map((t) => JSON.stringify(t)).join(", ")}.`, MissingOneOfPlugins: ({ missingPlugin: a }) => `This experimental syntax requires enabling one of the following parser plugin(s): ${a.map((t) => JSON.stringify(t)).join(", ")}.`, MissingUnicodeEscape: "Expecting Unicode escape sequence \\uXXXX.", MixingCoalesceWithLogical: "Nullish coalescing operator(??) requires parens when mixing with logical operators.", ModuleAttributeDifferentFromType: "The only accepted module attribute is `type`.", ModuleAttributeInvalidValue: "Only string literals are allowed as module attribute values.", ModuleAttributesWithDuplicateKeys: ({ key: a }) => `Duplicate key "${a}" is not allowed in module attributes.`, ModuleExportNameHasLoneSurrogate: ({ surrogateCharCode: a }) => `An export name cannot include a lone surrogate, found '\\u${a.toString(16)}'.`, ModuleExportUndefined: ({ localName: a }) => `Export '${a}' is not defined.`, MultipleDefaultsInSwitch: "Multiple default clauses.", NewlineAfterThrow: "Illegal newline after throw.", NoCatchOrFinally: "Missing catch or finally clause.", NumberIdentifier: "Identifier directly after number.", NumericSeparatorInEscapeSequence: "Numeric separators are not allowed inside unicode escape sequences or hex escape sequences.", ObsoleteAwaitStar: "'await*' has been removed from the async functions proposal. Use Promise.all() instead.", OptionalChainingNoNew: "Constructors in/after an Optional Chain are not allowed.", OptionalChainingNoTemplate: "Tagged Template Literals are not allowed in optionalChain.", OverrideOnConstructor: "'override' modifier cannot appear on a constructor declaration.", ParamDupe: "Argument name clash.", PatternHasAccessor: "Object pattern can't contain getter or setter.", PatternHasMethod: "Object pattern can't contain methods.", PrivateInExpectedIn: ({ identifierName: a }) => `Private names are only allowed in property accesses (\`obj.#${a}\`) or in \`in\` expressions (\`#${a} in obj\`).`, PrivateNameRedeclaration: ({ identifierName: a }) => `Duplicate private name #${a}.`, RecordExpressionBarIncorrectEndSyntaxType: "Record expressions ending with '|}' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionBarIncorrectStartSyntaxType: "Record expressions starting with '{|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionHashIncorrectStartSyntaxType: "Record expressions starting with '#{' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", RecordNoProto: "'__proto__' is not allowed in Record expressions.", RestTrailingComma: "Unexpected trailing comma after rest element.", SloppyFunction: "In non-strict mode code, functions can only be declared at top level or inside a block.", SloppyFunctionAnnexB: "In non-strict mode code, functions can only be declared at top level, inside a block, or as the body of an if statement.", SourcePhaseImportRequiresDefault: 'Only `import source x from "./module"` is valid.', StaticPrototype: "Classes may not have static property named prototype.", SuperNotAllowed: "`super()` is only valid inside a class constructor of a subclass. Maybe a typo in the method name ('constructor') or not extending another class?", SuperPrivateField: "Private fields can't be accessed on super.", TrailingDecorator: "Decorators must be attached to a class element.", TupleExpressionBarIncorrectEndSyntaxType: "Tuple expressions ending with '|]' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionBarIncorrectStartSyntaxType: "Tuple expressions starting with '[|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionHashIncorrectStartSyntaxType: "Tuple expressions starting with '#[' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", UnexpectedArgumentPlaceholder: "Unexpected argument placeholder.", UnexpectedAwaitAfterPipelineBody: 'Unexpected "await" after pipeline body; await must have parentheses in minimal proposal.', UnexpectedDigitAfterHash: "Unexpected digit after hash token.", UnexpectedImportExport: "'import' and 'export' may only appear at the top level.", UnexpectedKeyword: ({ keyword: a }) => `Unexpected keyword '${a}'.`, UnexpectedLeadingDecorator: "Leading decorators must be attached to a class declaration.", UnexpectedLexicalDeclaration: "Lexical declaration cannot appear in a single-statement context.", UnexpectedNewTarget: "`new.target` can only be used in functions or class properties.", UnexpectedNumericSeparator: "A numeric separator is only allowed between two digits.", UnexpectedPrivateField: "Unexpected private name.", UnexpectedReservedWord: ({ reservedWord: a }) => `Unexpected reserved word '${a}'.`, UnexpectedSuper: "'super' is only allowed in object methods and classes.", UnexpectedToken: ({ expected: a, unexpected: t }) => `Unexpected token${t ? ` '${t}'.` : ""}${a ? `, expected "${a}"` : ""}`, UnexpectedTokenUnaryExponentiation: "Illegal expression. Wrap left hand side or entire exponentiation in parentheses.", UnexpectedUsingDeclaration: "Using declaration cannot appear in the top level when source type is `script`.", UnsupportedBind: "Binding should be performed on object property.", UnsupportedDecoratorExport: "A decorated export must export a class declaration.", UnsupportedDefaultExport: "Only expressions, functions or classes are allowed as the `default` export.", UnsupportedImport: "`import` can only be used in `import()` or `import.meta`.", UnsupportedMetaProperty: ({ target: a, onlyValidPropertyName: t }) => `The only valid meta property for ${a} is ${a}.${t}.`, UnsupportedParameterDecorator: "Decorators cannot be used to decorate parameters.", UnsupportedPropertyDecorator: "Decorators cannot be used to decorate object literal properties.", UnsupportedSuper: "'super' can only be used with function calls (i.e. super()) or in property accesses (i.e. super.prop or super[prop]).", UnterminatedComment: "Unterminated comment.", UnterminatedRegExp: "Unterminated regular expression.", UnterminatedString: "Unterminated string constant.", UnterminatedTemplate: "Unterminated template.", UsingDeclarationExport: "Using declaration cannot be exported.", UsingDeclarationHasBindingPattern: "Using declaration cannot have destructuring patterns.", VarRedeclaration: ({ identifierName: a }) => `Identifier '${a}' has already been declared.`, YieldBindingIdentifier: "Can not use 'yield' as identifier inside a generator.", YieldInParameter: "Yield expression is not allowed in formal parameters.", ZeroDigitNumericSeparator: "Numeric separator can not be used after leading 0." }, ti = { StrictDelete: "Deleting local variable in strict mode.", StrictEvalArguments: ({ referenceName: a }) => `Assigning to '${a}' in strict mode.`, StrictEvalArgumentsBinding: ({ bindingName: a }) => `Binding '${a}' in strict mode.`, StrictFunction: "In strict mode code, functions can only be declared at top level or inside a block.", StrictNumericEscape: "The only valid numeric escape in strict mode is '\\0'.", StrictOctalLiteral: "Legacy octal literals are not allowed in strict mode.", StrictWith: "'with' in strict mode." }, si = /* @__PURE__ */ new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]), ii = { PipeBodyIsTighter: "Unexpected yield after pipeline body; any yield expression acting as Hack-style pipe body must be parenthesized due to its loose operator precedence.", PipeTopicRequiresHackPipes: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.', PipeTopicUnbound: "Topic reference is unbound; it must be inside a pipe body.", PipeTopicUnconfiguredToken: ({ token: a }) => `Invalid topic token ${a}. In order to use ${a} as a topic reference, the pipelineOperator plugin must be configured with { "proposal": "hack", "topicToken": "${a}" }.`, PipeTopicUnused: "Hack-style pipe body does not contain a topic reference; Hack-style pipes must use topic at least once.", PipeUnparenthesizedBody: ({ type: a }) => `Hack-style pipe body cannot be an unparenthesized ${Ie({ type: a })}; please wrap it in parentheses.`, PipelineBodyNoArrow: 'Unexpected arrow "=>" after pipeline body; arrow function in pipeline body must be parenthesized.', PipelineBodySequenceExpression: "Pipeline body may not be a comma-separated sequence expression.", PipelineHeadSequenceExpression: "Pipeline head should not be a comma-separated sequence expression.", PipelineTopicUnused: "Pipeline is in topic style but does not use topic reference.", PrimaryTopicNotAllowed: "Topic reference was used in a lexical context without topic binding.", PrimaryTopicRequiresSmartPipeline: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.' }, ri = ["toMessage"], ai = ["message"];
        ...
        function j(a, t) {
          ...
          for (let s of Object.keys(a)) {
            let i = a[s], r = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = r, o = Jt(r, ai), h = typeof n == "string" ? () => n : n;
            e[s] = ni(Object.assign({ code: "BABEL_PARSER_SYNTAX_ERROR", reasonCode: s, toMessage: h }, t ? { syntaxPlugin: t } : {}, o));
          }
          return e;
        }
        var p = Object.assign({}, j(Zs), j(ei), j(ti), j`pipelineOperator`(ii)), { defineProperty: oi } = Object, Bt = (a, t) => oi(a, t, { enumerable: false, value: a[t] });
        function he(a) {
        ...
        var b = true, m = true, Ve = true, le = true, V = true, li = true, Le = class {
          constructor(t, e = {}) {
        ...
        function _(a) {
          return a < 65 ? a === 36 : a <= 90 ? true : a < 97 ? a === 95 : a <= 122 ? true : a <= 65535 ? a >= 170 && bi.test(String.fromCharCode(a)) : Xe(a, Yt);
        }
        function Z(a) {
          return a < 48 ? a === 36 : a < 58 ? true : a < 65 ? false : a <= 90 ? true : a < 97 ? a === 95 : a <= 122 ? true : a <= 65535 ? a >= 170 && Ai.test(String.fromCharCode(a)) : Xe(a, Yt) || Xe(a, Si);
        }
        var At = { keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"], strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"], strictBind: ["eval", "arguments"] }, wi = new Set(At.keyword), Ci = new Set(At.strict), Ei = new Set(At.strictBind);
        function Qt(a, t) {
          return t && a === "await" || a === "enum";
        }
        function Zt(a, t) {
          return Qt(a, t) || Ci.has(a);
        }
        function es(a) {
          return Ei.has(a);
        }
        ...
        var ki = /* @__PURE__ */ new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
        function vi(a) {
          return ki.has(a);
        }
        var me = class {
        ...
        function ce(a, t, e) {
          ...
          for (; s === null && i > 0; )
            s = t[--i];
          s === null || s.start > e.start ? xe(a, e.comments) : ss(s, e.comments);
        }
        var Ze = class extends Qe {
          ...
          finalizeComment(t) {
            ...
            if (t.leadingNode !== null || t.trailingNode !== null)
              t.leadingNode !== null && ss(t.leadingNode, e), t.trailingNode !== null && Li(t.trailingNode, e);
            else {
        ...
        var et = class a {
          ...
          return t >= 48 && t <= 57;
        }, _t = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, Ee = { bin: (a) => a === 48 || a === 49, oct: (a) => a >= 48 && a <= 55, dec: (a) => a >= 48 && a <= 57, hex: (a) => a >= 48 && a <= 57 || a >= 65 && a <= 70 || a >= 97 && a <= 102 };
...
`);
        ...
        function rs(a, t, e, s, i, r, n, o, h, l) {
          let c = t, u = i === 16 ? _t.hex : _t.decBinOct, f = i === 16 ? Ee.hex : i === 10 ? Ee.dec : i === 8 ? Ee.oct : Ee.bin, d = false, y = 0;
          for (let E = 0, L = r ?? 1 / 0; E < L; ++E) {
            ...
            if (S >= 97 ? I = S - 97 + 10 : S >= 65 ? I = S - 65 + 10 : Mi(S) ? I = S - 48 : I = 1 / 0, I >= i) {
              if (I <= 9 && l)
                return { n: null, pos: t };
        ...
        var Bi = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          constructor(t) {
          ...
          readToken_numberSign() {
            ...
            if (e === 123 || e === 91 && this.hasPlugin("recordAndTuple")) {
              ...
              _(e) ? (++this.state.pos, this.finishToken(138, this.readWord1(e))) : e === 92 ? (++this.state.pos, this.finishToken(138, this.readWord1())) : this.finishOp(27, 1);
          }
          readToken_dot() {
          ...
          readNumber(t) {
            ...
            if (c === 46 && !h && (++this.state.pos, this.readInt(10), i = true, c = this.input.charCodeAt(this.state.pos)), (c === 69 || c === 101) && !h && (c = this.input.charCodeAt(++this.state.pos), (c === 43 || c === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(p.InvalidOrMissingExponent, s), i = true, o = true, c = this.input.charCodeAt(this.state.pos)), c === 110 && ((i || l) && this.raise(p.InvalidBigIntLiteral, s), ++this.state.pos, r = true), c === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (o || l) && this.raise(p.InvalidDecimal, s), ++this.state.pos, n = true), _(this.codePointAtPos(this.state.pos)))
              throw this.raise(p.NumberIdentifier, this.state.curPosition());
          ...
          readWord1(t) {
            ...
            for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
              ...
              if (Z(r))
                ...
                let n = this.state.curPosition(), o = this.state.pos === s ? _ : Z;
          ...
          checkKeywordEscapes() {
            ...
            Tt(t) && this.state.containsEsc && this.raise(p.InvalidEscapedReservedWord, this.state.startLoc, { reservedWord: K(t) });
          }
          raise(t, e, s = {}) {
        ...
        var Hi = /\*?\s*@((?:no)?flow)\b/, Wi = (a) => class extends a {
          constructor(...e) {
          ...
          flowParseDeclareModule(e) {
            ...
            let r = null, n = false;
            return i.forEach((o) => {
              Vi(o) ? (r === "CommonJS" && this.raise(g.AmbiguousDeclareModuleKind, o), r = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(g.DuplicateDeclareModuleExports, o), r === "ES" && this.raise(g.AmbiguousDeclareModuleKind, o), r = "CommonJS", n = true);
          ...
          flowParseDeclareExportDeclaration(e, s) {
            ...
            if (this.match(75) || this.isLet() || (this.isContextual(130) || this.isContextual(129)) && !s) {
              ...
              throw this.raise(g.UnsupportedDeclareExportKind, this.state.startLoc, { unsupportedExportKind: i, suggestion: zi[i] });
            }
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), l = 9, c = true) : (this.expect(5), l = 8, c = false), h.exact = c; !this.match(l); ) {
              ...
              if (this.eat(0))
                y != null && this.unexpected(y), this.eat(0) ? (S && this.unexpected(S.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(L, d))) : h.indexers.push(this.flowParseObjectTypeIndexer(L, d, S));
              else if (this.match(10) || this.match(47))
                y != null && this.unexpected(y), S && this.unexpected(S.loc.start), h.callProperties.push(this.flowParseObjectTypeCallProperty(L, d));
              else {
                let I = "init";
                if (this.isContextual(99) || this.isContextual(104)) {
                  let oe = this.lookahead();
                  Xt(oe.type) && (I = this.state.value, this.next());
                }
                let Se = this.flowParseObjectTypeProperty(L, d, y, S, I, i, n ?? !c);
                Se === null ? (u = true, E = this.state.lastTokStartLoc) : h.properties.push(Se);
              }
          ...
          getArrowLikeExpressions(e, s) {
            ...
            return s ? (r.forEach((n) => this.finishArrowValidation(n)), [r, []]) : Ki(r, (n) => n.params.every((o) => this.isAssignable(o, true)));
          }
          ...
          getTokenFromCode(e) {
            ...
            e === 123 && s === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? s === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : Ni(e, s, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
          }
          isAssignable(e, s) {
          ...
          parseImportSpecifier(e, s, i, r, n) {
            ...
            if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
              ...
              this.eatContextual(93) ? e.local = this.parseIdentifier() : (l = true, e.local = $(e.imported));
            }
            let c = $t(e);
            ...
            if ((i = n) != null && i.error || this.match(47)) {
              ...
              let l, c = this.tryParse((f) => {
                ...
                let y = this.forwardNoArrowParamsConversionAt(l, () => {
                  ...
                  return this.resetStartLocationFromNode(L, l), L;
                });
                (d = y.extra) != null && d.parenthesized && f();
                let E = this.maybeUnwrapTypeCastExpression(y);
                return E.type !== "ArrowFunctionExpression" && f(), E.typeParameters = l, this.resetStartLocationFromNode(E, l), y;
              }, r), u = null;
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          jsxParseIdentifier() {
            let e = this.startNode();
            return this.match(140) ? e.name = this.state.value : Tt(this.state.type) ? e.name = K(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
          }
          ...
          jsxParseElementAt(e) {
            ...
            if (!r.selfClosing) {
              ...
              z(r) && !z(n) && n !== null ? this.raise(W.MissingClosingTagFragment, n) : !z(r) && z(n) ? this.raise(W.MissingClosingTagElement, n, { openingTagName: Q(r.name) }) : !z(r) && !z(n) && Q(n.name) !== Q(r.name) && this.raise(W.MissingClosingTagElement, n, { openingTagName: Q(r.name) });
            }
            if (z(r) ? (s.openingFragment = r, s.closingFragment = n) : (s.openingElement = r, s.closingElement = n), s.children = i, this.match(47))
              throw this.raise(W.UnwrappedAdjacentJSXElements, this.state.startLoc);
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 142)
              ...
              this.state.canStartJSXElement = ui(i);
          }
        }, lt = class extends me {
          constructor(...t) {
        ...
        }, Xi = (a, t) => hasOwnProperty.call(a, t) && a[t], os = (a) => a.type === "ParenthesizedExpression" ? os(a.expression) : a, pt = class extends ht {
          ...
          isValidLVal(t, e, s) {
            return Xi({ AssignmentPattern: "left", RestElement: "argument", ObjectProperty: "value", ParenthesizedExpression: "expression", ArrayPattern: "elements", ObjectPattern: "properties" }, t);
          }
        ...
        }, Gi = (a, t) => hasOwnProperty.call(a, t) && a[t];
        function Yi(a) {
          if (a == null)
        ...
        var er = (a) => class extends a {
          ...
          tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = x.InvalidModifierOnTypeMember }, n) {
            ...
            for (; ; ) {
              ...
              if (!c)
                break;
              Vt(c) ? n.accessibility ? this.raise(x.DuplicateAccessibilityModifier, l, { modifier: c }) : (o(l, c, c, "override"), o(l, c, c, "static"), o(l, c, c, "readonly"), n.accessibility = c) : Zi(c) ? (n[c] && this.raise(x.DuplicateModifier, l, { modifier: c }), n[c] = true, o(l, c, "in", "out")) : (hasOwnProperty.call(n, c) ? this.raise(x.DuplicateModifier, l, { modifier: c }) : (o(l, c, "static", "readonly"), o(l, c, "static", "override"), o(l, c, "override", "readonly"), o(l, c, "abstract", "override"), h(l, c, "declare", "override"), h(l, c, "static", "abstract")), n[c] = true), s != null && s.includes(c) && this.raise(r, l, { modifier: c });
            }
          }
          ...
          tsParseDelimitedList(e, s, i) {
            return Yi(this.tsParseDelimitedListWorker(e, s, true, i));
          }
          ...
          parseVarStatement(e, s, i = false) {
            ...
            for (let { id: o, init: h } of n.declarations)
              h && (s !== "const" || o.typeAnnotation ? this.raise(x.InitializerNotAllowedInAmbientContext, h) : sr(h, this.hasPlugin("estree")) || this.raise(x.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, h));
            return n;
          }
          ...
          tsHasSomeModifiers(e, s) {
            return s.some((i) => Vt(i) ? e.accessibility === i : !!e[i]);
          }
          ...
          isValidLVal(e, s, i) {
            return Gi({ TSTypeCastExpression: true, TSParameterProperty: "parameter", TSNonNullExpression: "expression", TSInstantiationExpression: "expression", TSAsExpression: (i !== 64 || !s) && ["expression", true], TSSatisfiesExpression: (i !== 64 || !s) && ["expression", true], TSTypeAssertion: (i !== 64 || !s) && ["expression", true] }, e) || super.isValidLVal(e, s, i);
          }
          parseBindingAtom() {
          ...
          parseTypeOnlyImportExportSpecifier(e, s, i) {
            ...
            e[f] = l ? "type" : "value", c && this.eatContextual(93) && (e[n] = s ? this.parseIdentifier() : this.parseModuleExportName()), e[n] || (e[n] = $(e[r])), s && this.checkIdentifier(e[n], l ? 4098 : 4096);
          }
        };
        function tr(a) {
        ...
        function sr(a, t) {
          ...
          if (t) {
            ...
            return true;
          return !!(hs(a, t) || ir(a, t) || s === "TemplateLiteral" && a.expressions.length === 0 || tr(a));
        }
        function hs(a, t) {
        ...
        var zt = j`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), rr = (a) => class extends a {
          parsePlaceholder(e) {
            if (this.match(144)) {
              let s = this.startNode();
          ...
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              let e = this.nextTokenStart();
              if (this.isUnparsedContextual(e, "from") && this.input.startsWith(K(144), this.nextTokenStartSince(e + 4)))
                return true;
            }
        ...
        var Kt = ["minimal", "fsharp", "hack", "smart"], Ht = ["^^", "@@", "^", "%", "#"];
        function nr(a) {
          if (N(a, "decorators")) {
          ...
          if (N(a, "pipelineOperator")) {
            ...
            if (t === "hack") {
              ...
              if (!Ht.includes(i)) {
                let r = Ht.map((n) => `"${n}"`).join(", ");
                throw new Error(`"pipelineOperator" in "proposal": "hack" mode also requires a "topicToken" option whose value must be one of: ${r}.`);
              }
              if (i === "#" && s)
                throw new Error(`Plugin conflict between \`["pipelineOperator", { proposal: "hack", topicToken: "#" }]\` and \`${JSON.stringify(e)}\`.`);
            } else if (t === "smart" && s)
              throw new Error(`Plugin conflict between \`["pipelineOperator", { proposal: "smart" }]\` and \`${JSON.stringify(e)}\`.`);
          }
          ...
          if (N(a, "recordAndTuple")) {
            ...
            if (t != null) {
              let e = ["hash", "bar"];
              if (!e.includes(t))
                throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + e.map((s) => `'${s}'`).join(", "));
            }
          }
        ...
        var ut = class extends pt {
          ...
          parseMaybeAssign(t, e) {
            ...
            if (e && (n = e.call(this, n, s)), fi(this.state.type)) {
          ...
          parseExprOp(t, e, s) {
            ...
            if (mi(i) && (this.prodParam.hasIn || !this.match(58))) {
              let r = Ne(i);
              if (r > s) {
                if (i === 39) {
          ...
          parseExprOpBaseRightExpr(t, e) {
            let s = this.state.startLoc;
            return this.parseExprOp(this.parseMaybeUnaryOrPrivate(), s, Ti(t) ? e - 1 : e);
          }
          parseHackPipeBody() {
            var t;
            let { startLoc: e } = this.state, s = this.parseMaybeAssign();
            return si.has(s.type) && !((t = s.extra) != null && t.parenthesized) && this.raise(p.PipeUnparenthesizedBody, e, { type: s.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, e), s;
          }
          ...
          parseUpdate(t, e, s) {
            ...
            if (this.checkExpressionErrors(s, false))
              return r;
            for (; yi(this.state.type) && !this.canInsertSemicolon(); ) {
          ...
          parseCoverCallAndAsyncArrowHead(t, e, s, i) {
            ...
            h && (this.expressionScope.enter(_i()), n = new ee()), l && (o.optional = i), i ? o.arguments = this.parseCallExpressionArguments(11) : o.arguments = this.parseCallExpressionArguments(11, t.type === "Import", t.type !== "Super", o, n);
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
        ...
        }, He = { kind: 1 }, lr = { kind: 2 }, cr = /[\uD800-\uDFFF]/u, We = /in(?:stanceof)?/y;
        function pr(a, t) {
          for (let e = 0; e < a.length; e++) {
            ...
            if (typeof i == "number") {
              {
                if (i === 138) {
                  let { loc: r, start: n, value: o, end: h } = s, l = n + 1, c = v(r.start, 1);
                  a.splice(e, 1, new O({ type: R(27), value: "#", start: n, end: l, startLoc: r.start, endLoc: c }), new O({ type: R(132), value: o, start: l, end: h, startLoc: c, endLoc: r.end })), e++;
                  continue;
                }
                if (De(i)) {
                  let { loc: r, start: n, value: o, end: h } = s, l = n + 1, c = v(r.start, 1), u;
                  t.charCodeAt(n) === 96 ? u = new O({ type: R(22), value: "`", start: n, end: l, startLoc: r.start, endLoc: c }) : u = new O({ type: R(8), value: "}", start: n, end: l, startLoc: r.start, endLoc: c });
                  let f, d, y, E;
                  i === 24 ? (d = h - 1, y = v(r.end, -1), f = o === null ? null : o.slice(1, -1), E = new O({ type: R(22), value: "`", start: d, end: h, startLoc: y, endLoc: r.end })) : (d = h - 2, y = v(r.end, -2), f = o === null ? null : o.slice(1, -2), E = new O({ type: R(23), value: "${", start: d, end: h, startLoc: y, endLoc: r.end })), a.splice(e, 1, u, new O({ type: R(20), value: f, start: l, end: d, startLoc: c, endLoc: y }), E), e += 2;
                  continue;
                }
              }
              s.type = R(i);
        ...
        var ft = class extends ut {
          parseTopLevel(t, e) {
            return t.program = this.parseProgram(e), t.comments = this.comments, this.options.tokens && (t.tokens = pr(this.tokens, this.input)), this.finishNode(t, "File");
          }
          ...
          parseSwitchStatement(t) {
            ...
            let e = t.cases = [];
            this.expect(5), this.state.labels.push(lr), this.scope.enter(0);
            let s;
          ...
          parseLabeledStatement(t, e, s, i) {
            ...
            let r = di(this.state.type) ? 1 : this.match(71) ? 2 : null;
          ...
          parseFunctionParams(t, e) {
            this.expect(10), this.expressionScope.enter(Ri()), t.params = this.parseBindingList(11, 41, 2 | (e ? 4 : 0)), this.expressionScope.exit();
          }
          ...
          parseClassMemberWithIsStatic(t, e, s, i) {
            ...
            if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
              ...
              E ? this.pushClassPrivateProperty(t, h) : this.pushClassProperty(t, o);
            else if (y === "async" && !this.isLineTerminator()) {
              this.resetPreviousNodeTrailingComments(d);
              let S = this.eat(55);
              u.optional && this.unexpected(L), c.kind = "method";
              ...
              this.resetPreviousNodeTrailingComments(d), c.kind = y;
              let S = this.match(138);
              ...
              let S = this.match(138);
              this.parseClassElementName(o), this.pushClassAccessorProperty(t, l, S);
            } else
              this.isLineTerminator() ? E ? this.pushClassPrivateProperty(t, h) : this.pushClassProperty(t, o) : this.unexpected();
          }
          ...
          parseExportSpecifier(t, e, s, i) {
            return this.eatContextual(93) ? t.exported = this.parseModuleExportName() : e ? t.exported = $i(t.local) : t.exported || (t.exported = $(t.local)), this.finishNode(t, "ExportSpecifier");
          }
          parseModuleExportName() {
            if (this.match(133)) {
              let t = this.parseStringLiteral(this.state.value), e = t.value.match(cr);
          ...
          constructor(t, e) {
            t = hr(t), super(t, e), this.options = t, this.initializeScopes(), this.plugins = ur(this.options.plugins), this.filename = t.sourceFilename;
          }
          getScopeHandler() {
            return ye;
          }
        ...
        function ue(a, t) {
          let e = Oe;
          return a != null && a.plugins && (nr(a.plugins), e = xr(a.plugins)), new e(a, t);
        }
        var Wt = {};
        function xr(a) {
          let t = or.filter((i) => N(a, i)), e = t.join("/"), s = Wt[e];
          if (!s) {
            s = Oe;
            for (let i of t)
              s = cs[i](s);
      ...
      var Ls = Lt((G) => {
        ...
        function vs(a) {
          let t = `
`;
          a = a.replace(Rr, "").replace(Br, "").replace(jr, "$1");
          let e = "";
          for (; e !== a; )
            e = a, a = a.replace(_r, `${t}$1 $2${t}`);
          a = a.replace(Cs, "").trimRight();
          let s = /* @__PURE__ */ Object.create(null), i = a.replace(Es, "").replace(Cs, "").trimRight(), r;
          for (; r = Es.exec(a); ) {
            let n = r[2].replace(Ur, "");
            typeof s[r[1]] == "string" || Array.isArray(s[r[1]]) ? s[r[1]] = ks.concat(s[r[1]], n) : s[r[1]] = n;
          }
          return { comments: i, pragmas: s };
        }
        function zr({ comments: a = "", pragmas: t = {} }) {
          let e = `
`, s = "/**", i = " *", r = " */", n = Object.keys(t), o = n.flatMap((l) => Is(l, t[l])).map((l) => `${i} ${l}${e}`).join("");
          if (!a) {
            if (n.length === 0)
              return "";
            if (n.length === 1 && !Array.isArray(t[n[0]])) {
              let l = t[n[0]];
              return `${s} ${Is(n[0], l)[0]}${r}`;
            }
          }
        ...
        function Is(a, t) {
          return ks.concat(t).map((e) => `@${a} ${e}`.trim());
        }
      });
      var ra = {};
      Ys(ra, { parsers: () => ia });
...
` || i === "\r" || i === "\u2028" || i === "\u2029")
      ...
      var ds = gr;
      function Tr(a, t) {
        return t === false ? false : a.charAt(t) === "/" && a.charAt(t + 1) === "/" ? us(a, t) : t;
      }
      var ms = Tr;
      function br(a, t) {
        let e = null, s = t;
        for (; s !== e; )
          e = s, s = ps(a, s), s = fs(a, s), s = ms(a, s), s = ds(a, s);
        return s;
      }
      var ys = br;
      function Ar(a) {
...
`);
      ...
      var Ps = Er;
      var Ir = Ps(["Block", "CommentBlock", "MultiLine"]), Te = Ir;
      function Nr(a) {
        let t = `*${a.value}*`.split(`
`);
      ...
      function Mr(a, t) {
        ...
        if (e === "babel") {
          ...
          a = Re(a, (r) => {
            var n;
            (n = r.leadingComments) != null && n.some(gs) && i.add(D(r));
          }), a = Re(a, (r) => {
      ...
      function kt(a) {
        return Ss(a) ? kt({ type: "LogicalExpression", operator: a.operator, left: kt({ type: "LogicalExpression", operator: a.operator, left: a.left, right: a.right.left, range: [D(a.left), B(a.right.left)] }), right: a.right.right, range: [D(a), B(a)] }) : a;
      }
      var ws = Mr;
      function Or(a, t) {
      ...
      function Hr(a) {
        return a = typeof a == "function" ? { parse: a } : a, { astFormat: "estree", hasPragma: Ds, locStart: D, locEnd: B, ...a };
      }
      var Y = Hr;
      function Wr(a) {
        let { filepath: t } = a;
      ...
      function Yr(a, t) {
        ...
        let s = ys(a, 0);
        return s !== false && (a = a.slice(0, s)), Gr.test(a);
      }
      function Qr(a, t, e) {
        let s = a(t, e), i = s.errors.find((r) => !ea.has(r.reasonCode));
        if (i)
          throw i;
        return s;
      }
      function Zr({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          if ((s.parser === "babel" || s.parser === "__babel_estree") && Yr(e, s))
            return s.parser = "babel-flow", $s.parse(e, s);
          let i = t;
          (s.__babelSourceType ?? Ms(s)) === "script" && (i = i.map((l) => ({ ...l, sourceType: "script" })));
          let n = /%[A-Z]/.test(e);
          e.includes("|>") ? i = (n ? [...Fs, Os] : Fs).flatMap((c) => i.map((u) => q([c], u))) : n && (i = i.map((l) => q([Os], l)));
          let o = a ? $e.parseExpression : $e.parse, h;
          try {
            h = xs(i.map((l) => () => Qr(o, e, l)));
          } catch ({ errors: [l] }) {
            throw _e(l);
          }
          return a && (h = je(h, { text: e, rootMarker: s.rootMarker })), ws(h, { parser: "babel", text: e });
        };
      }
      var ea = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), js = [q(["jsx"])], Bs = ae({ optionsCombinations: js }), Rs = ae({ optionsCombinations: [q(["jsx", "typescript"]), q(["typescript"])] }), Us = ae({ isExpression: true, optionsCombinations: [q(["jsx"])] }), _s = ae({ isExpression: true, optionsCombinations: [q(["typescript"])] }), $s = ae({ optionsCombinations: [q(["jsx", ["flow", { all: true, enums: true }], "flowComments"])] }), ta = ae({ optionsCombinations: js.map((a) => q(["estree"], a)) }), qs = { babel: Bs, "babel-flow": $s, "babel-ts": Rs, __js_expression: Us, __ts_expression: _s, __vue_expression: Us, __vue_ts_expression: _s, __vue_event_binding: Bs, __vue_ts_event_binding: Rs, __babel_estree: ta };
      var Vs = qe(wt(), 1);
      function zs(a = {}) {
        ...
        return function(s) {
          let i;
          try {
            i = (0, Vs.parseExpression)(s, { tokens: true, ranges: true, attachComment: false });
          } catch (r) {
            throw _e(r);
          }
          if (!t && ge(i.comments))
      ...
      var vt = zs(), sa = { json: Y({ parse: vt, hasPragma() {
        return true;
      } }), json5: Y(vt), jsonc: Y(vt), "json-stringify": Y({ parse: zs({ allowComments: false }), astFormat: "estree-json" }) }, Ks = sa;
      var ia = { ...qs, ...Ks };
      return Qs(ra);
    });
  }
