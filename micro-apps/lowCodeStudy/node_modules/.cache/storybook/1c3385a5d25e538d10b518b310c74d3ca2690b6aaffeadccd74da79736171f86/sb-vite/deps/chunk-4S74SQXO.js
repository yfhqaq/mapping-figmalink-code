import {
  ...
  SyntaxHighlighter2,
  useComposedRefs
} from "./chunk-KLCYGERU.js";
import {
  WithToolTipState
} from "./chunk-F42MTYMV.js";
import {
  _extends,
...
import {
  require_react_dom
} from "./chunk-MXU5IL7U.js";
import {
  require_react
} from "./chunk-L2EHWIWD.js";
import {
  __export,
  __toESM
...
var SideCar = function(_a) {
  ...
  return React16.createElement(Target, __assign2({}, rest));
};
...
var LazySyntaxHighlighter = (0, import_react4.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-BP7B2CQK-HUSCPEJL.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react4.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-BP7B2CQK-HUSCPEJL.js"), import("./formatter-2WMMO6ZP-LTB2HDVI.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
var ErrorFormatter = ({ error }) => {
  if (!error)
    return import_react4.default.createElement(import_react4.Fragment, null, "This error has no stack or message");
  if (!error.stack)
    return import_react4.default.createElement(import_react4.Fragment, null, error.message || "This error has no stack or message");
...
${input}`);
  ...
  if (!match)
    return import_react4.default.createElement(import_react4.Fragment, null, input);
...
var LazyWithTooltip = (0, import_react4.lazy)(() => import("./WithTooltip-KJL26V4Q-FJQW6Y35.js").then((mod) => ({ default: mod.WithTooltip })));
...
var LazyWithTooltipPure = (0, import_react4.lazy)(() => import("./WithTooltip-KJL26V4Q-FJQW6Y35.js").then((mod) => ({ default: mod.WithTooltipPure })));
...
function ForwardRefFunction({ children, ...rest }, ref) {
  ...
  if (isLink(o))
    return import_react4.default.createElement("a", { ref: o.ref, ...o.props }, children);
  if (isButton(o))
    return import_react4.default.createElement("button", { ref: o.ref, type: "button", ...o.props }, children);
...
var Loader = ({ progress, error, size, ...props }) => {
  if (error)
    return import_react4.default.createElement(ProgressWrapper, { "aria-label": error.toString(), "aria-live": "polite", role: "status", ...props }, import_react4.default.createElement(ErrorIcon, null), import_react4.default.createElement(ProgressMessage, null, error.message));
  if (progress) {
...
//# sourceMappingURL=chunk-4S74SQXO.js.map
