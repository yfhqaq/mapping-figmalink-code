...
async function main() {
  ...
  server.registerTool(
    "component.get",
    {
      ...
      description:
        "Fetch component details (props, examples, file paths, related guidelines).",
      inputSchema: {
        id: z
          .string()
          .min(1)
  ...
  server.registerTool(
    "guidelines.get",
    {
      ...
      description:
        "Get relevant company guidelines for components, styling, naming, accessibility, etc.",
      inputSchema: {
  ...
  server.registerTool(
    "docs.search",
    {
      title: "Search docs",
      description:
        "Search internal docs/knowledge base for relevant snippets and references.",
      inputSchema: {
