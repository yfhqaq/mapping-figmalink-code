...
exports.getDepPkgName = exports.getPkgNameFromPath = exports.isFilePath = exports.logger = exports.getNestedTypeDepsForPkg = exports.getDepPkgPath = exports.isBuiltInModule = exports.getDtsInfoForPkgPath = exports.getPkgNameWithTypesOrg = exports.getPkgNameFromTypesOrg = exports.getTypeFromPkgJson = exports.getCache = exports.getCachePath = void 0;
...
function getCachePath() {
    return process.env.FATHER_CACHE_DIR || constants_1.DEFAULT_CACHE_PATH;
}
...
function getCache(ns) {
    ...
    if (process.env.FATHER_CACHE === 'none') {
        ...
        return { set: deferrer, get: deferrer, setSync() { }, getSync() { } };
    }
    return ((_a = caches[ns]) !== null && _a !== void 0 ? _a : (caches[ns] = (0, file_system_cache_1.default)({ basePath: path_1.default.join(getCachePath(), ns) })));
}
...
function getPkgNameFromPath(p) {
    var _a;
    return (_a = p.match(/^(?:@[a-z\d][\w-.]*\/|node:)?[a-z\d][\w-.]*/i)) === null || _a === void 0 ? void 0 : _a[0];
}
