(() => {
  var __webpack_modules__ = {
    58: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const { HtmlWebpackChildCompiler } = __nccwpck_require__(875);
    ...
    919: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const { CachedChildCompilation } = __nccwpck_require__(58);
      const { createHtmlTagObject, htmlTagObjectToString, HtmlTagArray } =
        __nccwpck_require__(750);
      const prettyError = __nccwpck_require__(840);
      const chunkSorter = __nccwpck_require__(657);
      const getHtmlRspackPluginHooks =
        __nccwpck_require__(783).getHtmlRspackPluginHooks;
